// This is an override of the default zustand-persist implementation, it avoids "Cannot use 'import.meta' outside a module" error.
// Source: https://github.com/pedroafsouza/expo-zustand-persist/blob/main/src/Persist.ts
...
const persistImpl = ((
    config: StateCreator<Record<string, unknown>, [], []>,
    baseOptions: PersistOptions<
